...
// Generated 30 oct. 2021 19:34:13 by Hibernate Tools 5.4.30.Final
...
/**
 * BitacoraSeguimientoInfluenza generated by hbm2java
 */
@Entity
@Table(name = "bitacora_seguimiento_influenza", schema = "public", uniqueConstraints = @UniqueConstraint(columnNames = "sec_bit_seg_influenza"))
public class BitacoraSeguimientoInfluenza implements java.io.Serializable {

	private int secBitSegInfluenza;
	...
	public BitacoraSeguimientoInfluenza() {
	}

	public BitacoraSeguimientoInfluenza(int secBitSegInfluenza, int secHojaInfluenza, Date fechaSeguimiento,
			short usuarioMedico, String consultaInicial, String fiebre, String tos, String secrecionNasal,
			String dolorGarganta, String congestionNasa, String dolorCabeza, String faltaApetito, String dolorMuscular,
			String dolorArticular, String dolorOido, String respiracionRapida, String dificultadRespirar,
			String faltaEscuela, String quedoEnCama, int controlDia) {
		this.secBitSegInfluenza = secBitSegInfluenza;
	...
	public BitacoraSeguimientoInfluenza(int secBitSegInfluenza, int secHojaInfluenza, Date fechaSeguimiento,
			...
			String dolorGarganta, String congestionNasa, String dolorCabeza, String faltaApetito, String dolorMuscular,
			String dolorArticular, String dolorOido, String respiracionRapida, String dificultadRespirar,
			String faltaEscuela, String quedoEnCama, int controlDia, String fiebreLeve, String fiebreModerada,
			String fiebreSevera, String tosLeve, String tosModerada, String tosSevera, String secrecionNasalLeve,
			String secrecionNasalModerada, String secrecionNasalSevera, String dolorGargantaLeve,
			String dolorGargantaModerada, String dolorGargantaSevera, String dolorCabezaLeve,
			String dolorCabezaModerada, String dolorCabezaSevera, String dolorMuscularLeve,
			String dolorMuscularModerada, String dolorMuscularSevera, String dolorArticularLeve,
			String dolorArticularModerada, String dolorArticularSevera, String cuadroConfusional,
			String cuadroNeurologico, String confusionMental, String anosmia, String ageusia, String mareo,
			String ictus, String sincope) {
		this.secBitSegInfluenza = secBitSegInfluenza;
		this.secHojaInfluenza = secHojaInfluenza;
		this.fechaSeguimiento = fechaSeguimiento;
		this.usuarioMedico = usuarioMedico;
	...
	@Id
	@SequenceGenerator(name = "id_sec_bit_seg_influenza", sequenceName = "bitacora_seguimiento_influenza_sec_bit_seg_influenza_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "id_sec_bit_seg_influenza")
	@Column(name = "sec_bit_seg_influenza", unique = true, nullable = false)
	public int getSecBitSegInfluenza() {
		return this.secBitSegInfluenza;
	}

	public void setSecBitSegInfluenza(int secBitSegInfluenza) {
		this.secBitSegInfluenza = secBitSegInfluenza;
	}
